...
public class Mov extends Instruction {
    ...
    public Mov(Integer modifierA,Integer addressA,Integer modifierB,Integer addressB,Warrior w){
    ...
    public int execution(int pointer, VirtualMachine memory, Warrior w) {
        ...
        if(this.getModifierA()==1){
            ...
            temppointer=(pointer+this.getAddressB()) %VirtualMachine.TAILLE;
            ...
            /*
            L'adresse est direct, cas particulier
             */
            if(this.getModifierB()==1){

                temppointer=this.getAddressB()%VirtualMachine.TAILLE;
            ...
            if(this.getModifierA()==2){
                ...
                temppointer=this.indirectToRelative(source,temppointer,VirtualMachine.TAILLE);
                source=memory.getFromMemory(temppointer);
            }
