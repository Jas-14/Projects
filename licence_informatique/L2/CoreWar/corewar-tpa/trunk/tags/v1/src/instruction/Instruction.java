...
public abstract class Instruction implements Cloneable{
     ...
     */
    public Instruction(Integer modifierA,Integer addressA,Integer modifierB,Integer addressB) {
     ...
     */
    public abstract int execution(int pointer, VirtualMachine memory);
